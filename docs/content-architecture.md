...
The engine judges player input against the required pattern and timing. Successful performance builds persistent resistance strength and helps recover safety. Authored phase pressure is multiplied by the remaining exposed fraction, `1 − resistance strength`, until a miss weakens that protection. READY and REST preserve the earned value. The same engine clock should drive judgement and the audio, visual, and optional haptic cues that communicate the rhythm.
