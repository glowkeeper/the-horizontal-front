...
The canonical project must:

1. Remain free to play, without a purchase price, advertising, loot boxes, premium currency, pay-to-win mechanics or paid access.
2. Distribute its software and distributable cultural materials as free/open-source work forming part of the digital commons.
3. Avoid player tracking, behavioural analytics, sale or transmission of player data, manipulative engagement systems and artificial retention machinery.
4. Remain accountable to players and contributors rather than investors, advertisers, donors or commercial platforms.
5. Provide public, accessible ways to inspect development, propose changes and contribute.
6. Treat accessibility, translation, modest hardware requirements and offline play as design requirements.
7. Connect its satire to mutual aid, labour history, enclosure, collective action and horizontal governance through appropriate educational context.
8. Use static, offline-capable delivery that does not require an account, application backend or permanent network connection after the required files have been cached.
9. Disclose material sources of project funding and major project expenses. Voluntary support must not purchase access, gameplay advantages or control.
10. Never sell the canonical project, enclose it behind a paywall or convert it into an advertising or data-extraction platform.

## Decision rule

Product, technical, funding and governance decisions must comply with the protected commitments. Convenience, growth, funding, platform requirements and contributor preference do not override them.

Anyone may raise a charter concern through the public issue tracker. Work that plausibly conflicts with the charter must pause until the concern is answered in public. The maintainer must explain the decision against the relevant commitment rather than relying only on authority or intention.
